  ...
  getData();
    ...
    if(state){
      axios.post("http://127.0.0.1:3002/cartsDatabase",{
        id: Math.floor(Math.random()*1000000)+"h"+Math.floor(Math.random()*100000000)+"sd"+"adf",
        name: item.name,
            ...
            <div className="detail-left">
              ...
              <div  className="product-varients">
                ...
                <div className="img2 varients-img">
                  <img onClick={changeImage} src={item.images.image1} alt="" />
                </div>
                <div className="img3 varients-img">
                  <img onClick={changeImage} src={item.images.image2} alt="" />
                </div>
                <div className="img4 varients-img">
                  <img onClick={changeImage} src={item.images.image3} alt="" />
                </div>
              </div>
            </div>
