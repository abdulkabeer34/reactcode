          ...
          <Row className="align-items-center">
            ...
            <Col md={6} className="mb-4 mb-md-0">
              <div className="pe-md-5">
                ...
                <p className="lead">
                  We Are <span className="text-warning fw-bold">Powerful Together</span>
                </p>
          ...
          <Row className="text-center">
            <Col md={4} className="mb-4">
              <div className="p-4 border rounded h-100">
                ...
                <p className="text-muted mb-0">Fully customizable features tailored to your needs.</p>
              </div>
            </Col>
            <Col md={4} className="mb-4">
              <div className="p-4 border rounded h-100">
                ...
                <p className="text-muted mb-0">State-of-the-art security built-in by default.</p>
              </div>
            </Col>
            <Col md={4} className="mb-4">
              <div className="p-4 border rounded h-100">
                ...
                <p className="text-muted mb-0">A large community of users and contributors worldwide.</p>
              </div>
            </Col>
          </Row>
        </Container>
