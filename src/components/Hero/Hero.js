    ...
    <div class="hero-main">
      <div class="hero-left">
        <div class="content">
          ...
          <h2  style={{ '--i': 3 }}>Exclusive Offer <span>-35%</span> Off this week</h2>
          <div  style={{ '--i': 4 }} class="btn">Shop now<i class="fas fa-arrow-right"></i></div>
        </div>
      </div>
      <div class="hero-right">
        <img class="hero-image entry" src={require("./slider-img-1 (1).png")} alt=""/>
      </div>
    </div>
  </div>
